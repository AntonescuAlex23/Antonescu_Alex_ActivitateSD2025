...
int main() {
	...
	NodListaPrincipala* graf=citireNoduriMasiniDinFisier("/Users/alexantonescu/Documents/SEMINAR-SDD12/masini.txt");
	citireMuchiiDinFisier(graf,"/Users/alexantonescu/Documents/SEMINAR-SDD12/muchii.txt");
